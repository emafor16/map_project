...
public class ControllerMenu {
    ...
    public void learningFromDb(ActionEvent actionEvent) throws IOException{
        ...
        ClientExtension.Utility.newWindow(stage, getClass(), "/Resources/DBconnection.fxml", "Quality-Threshold");
    }
    ...
    public void learningFromFile(ActionEvent actionEvent) throws IOException{
        Stage stage = (Stage) ((Node) actionEvent.getSource()).getScene().getWindow();
        ClientExtension.Utility.newWindow(stage, getClass(), "/Resources/Lettura.fxml", "Quality-Threshold");
    }
}
