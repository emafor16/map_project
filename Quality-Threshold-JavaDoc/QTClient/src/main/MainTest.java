...
public class MainTest {
	...
	private String learningFromDbTable() throws SocketException, ServerException, IOException, ClassNotFoundException {
		...
		do {
			...
			if (r <= 0) {
				System.out.println("Errore: inserire un valore di raggio maggiore di 0.");
			}
		} while (r <= 0);
		out.writeObject(r);
		String result = (String) in.readObject();
	 ...
	 *
	 * @param args argomenti della riga di comando, in questo caso l'IP e la porta del Server
	 */
