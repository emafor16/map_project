...
public class Tuple {
    ...
    //double avgDistance(Data data, int[] clusterData) restituisce la media delle distanze tra la tupla corrente e quelle ottenibili dalle righe della matrice data aventi indice in clusterData
